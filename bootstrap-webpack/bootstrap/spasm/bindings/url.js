...
export default {
  jsExports: {
    ...
    URL_username_Get: function(rawResult, ctx) {
      spasm.encode.string(rawResult, spasm.objects[ctx].username);
    },
    ...
    URL_password_Get: function(rawResult, ctx) {
      spasm.encode.string(rawResult, spasm.objects[ctx].password);
    },
    ...
    URL_toJSON: function(rawResult, ctx) {
      spasm.encode.string(rawResult, spasm.objects[ctx].toJSON());
    },
    URL_createObjectURL__Handle: function(rawResult, ctx, blob) {
      spasm.encode.string(rawResult, spasm.objects[ctx].createObjectURL(spasm.objects[blob]));
    },
