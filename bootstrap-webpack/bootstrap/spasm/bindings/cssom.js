...
export default {
  jsExports: {
    ...
    MediaList_mediaText_Get: function(rawResult, ctx) {
      spasm.encode.string(rawResult, spasm.objects[ctx].mediaText);
    },
    ...
    StyleSheet_href_Get: function(rawResult, ctx) {
      spasm.encode.optional_string(rawResult, spasm.objects[ctx].href);
    },
    StyleSheet_ownerNode_Get: function(rawResult, ctx) {
      spasm.encode.optional_union2_Element_ProcessingInstruction(rawResult, spasm.objects[ctx].ownerNode);
    },
    StyleSheet_parentStyleSheet_Get: function(rawResult, ctx) {
      spasm.encode.optional_Handle(rawResult, spasm.objects[ctx].parentStyleSheet);
    },
    StyleSheet_title_Get: function(rawResult, ctx) {
      spasm.encode.optional_string(rawResult, spasm.objects[ctx].title);
    },
